...
const en: Dictionary = {
  ...
  hiw_title: 'Why Appraisal Canada',
  ...
  ct_city: 'City / Town',
  ct_city_ph: 'Which city or town is the property in?',
...
const fr: Dictionary = {
  ...
  // How it works / trusted network
  hiw_title: 'Pourquoi Appraisal Canada',
  ...
  ct_city: 'Ville',
  ct_city_ph: 'Dans quelle ville se trouve la propriété?',
...
const es: Dictionary = {
  ...
  ct_city: 'Ciudad',
  ct_city_ph: '¿En qué ciudad está la propiedad?',
