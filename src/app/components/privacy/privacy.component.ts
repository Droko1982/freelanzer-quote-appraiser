...
export class PrivacyComponent {
  ...
  constructor() {
    effect(() => {
      const l = this.L.lang();
      const t = l === 'fr' ? 'Politique de confidentialité | Appraisal Canada'
        : l === 'es' ? 'Política de privacidad | Appraisal Canada'
  ...
  intro(): string {
    switch (this.l()) {
      case 'fr': return 'Appraisal Canada respecte votre vie privée. Cette politique explique quels renseignements nous recueillons, comment nous les utilisons et vos droits, conformément à la Loi sur la protection des renseignements personnels et les documents électroniques (LPRPDE / PIPEDA) du Canada.';
      case 'es': return 'Appraisal Canada respeta tu privacidad. Esta política explica qué información recopilamos, cómo la usamos y tus derechos, conforme a la ley canadiense PIPEDA.';
      default: return 'Appraisal Canada respects your privacy. This policy explains what information we collect, how we use it, and your rights, in accordance with Canada’s Personal Information Protection and Electronic Documents Act (PIPEDA).';
    }
  }
  ...
  sections(): Section[] {
    switch (this.l()) {
      case 'fr': return [
        ...
        { h: 'Vos droits', p: [
          'Vous pouvez demander l’accès, la correction ou la suppression de vos renseignements personnels en nous écrivant à info@appraisalcanada.ca.'] },
        { h: 'Sécurité', p: [
        ...
        { h: 'Nous joindre', p: [
          'Pour toute question sur cette politique : info@appraisalcanada.ca.'] },
        { h: 'Modifications', p: [
      ...
      case 'es': return [
        ...
        { h: 'Tus derechos', p: [
          'Puedes solicitar acceso, corrección o eliminación de tu información personal escribiéndonos a info@appraisalcanada.ca.'] },
        { h: 'Seguridad', p: [
          'Tomamos medidas razonables para proteger tu información. Ninguna transmisión por Internet es 100% segura.'] },
        { h: 'Contáctanos', p: [
          'Para cualquier pregunta sobre esta política: info@appraisalcanada.ca.'] },
        { h: 'Cambios', p: [
      ...
      default: return [
        ...
        { h: 'Your rights', p: [
          'You may request access to, correction of, or deletion of your personal information by emailing info@appraisalcanada.ca.'] },
        { h: 'Security', p: [
          'We take reasonable measures to protect your information. No transmission over the internet is fully secure.'] },
        { h: 'Contact us', p: [
          'For any questions about this policy: info@appraisalcanada.ca.'] },
        { h: 'Changes', p: [
